          ...
          {!previewUrl ? (
            <div 
              ...
              className={`relative group cursor-pointer rounded-2xl border-2 border-dashed transition-all duration-300 p-10 text-center ${
                isDragging ? 'border-indigo-500 bg-indigo-50' : 'border-slate-300 bg-slate-50 hover:border-indigo-500 hover:bg-indigo-50'
              }`}
            >
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg bg-black aspect-[9/16] max-h-[500px] mx-auto relative group">
              <video src={previewUrl} className="w-full h-full object-contain" controls playsInline></video>
              <button 
          ...
          {loading && (
            <div className="bg-slate-50 rounded-xl p-5 border border-slate-100">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-medium text-slate-700 text-sm">{status}</span>
              </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-slate-50 rounded-xl p-5 border border-slate-200 relative group">
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <CopyButton text={board.ai_prompt_cn} title="复制中文提示词" className="text-slate-400 hover:text-indigo-600 transition-colors cursor-pointer" />
                          </div>
                        ...
                        <div className="bg-indigo-50/50 rounded-xl p-5 border border-indigo-100 relative group">
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <CopyButton text={board.ai_prompt_en} title="复制英文提示词" className="text-indigo-400 hover:text-indigo-600 transition-colors cursor-pointer" />
                          </div>
